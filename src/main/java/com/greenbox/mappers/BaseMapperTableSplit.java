...
public interface BaseMapperTableSplit<T, P> {
     ...
     */
    Integer updateByQuery(@Param("tableName") String tableName, @Param("bean") T t, @Param("query") P p);

    /**
     * deleteByParam: (多条件删除)
     */
    Integer deleteByQuery(@Param("tableName") String tableName, @Param("query") P p);
}
